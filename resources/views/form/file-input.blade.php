...
<div class="relative mb-5">
    <label for="{{ $name }}" class="flex min-h-[100px] w-full cursor-pointer items-center justify-center rounded-md border border-dashed border-primary p-6">
       <div>
          <input type="file" name="{{ $name }}" id="{{ $id }}" class="sr-only">
          <span class="mx-auto mb-3 flex h-[50px] w-[50px] items-center justify-center rounded-full border border-stroke bg-white">
